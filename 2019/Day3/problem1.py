...
def run():
    ...
    min_distance = get_closest_intersection(instructions2, segments1)

    print(min_distance)
    
def get_closest_intersection(instructions2, segments1):
    currX = 0
    currY = 0 
    ...
    for instruction in instructions2:
        ...
        for segment in segments1:
            ...
            if is_intersection:
                distance = get_manhattan_distance_from_center(intersection_point[0], intersection_point[1])
